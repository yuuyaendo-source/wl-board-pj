    ...
    return (
        <div className={styles.toolbar}>
            <div className={styles.primaryBlock}>
                ...
                <div className={`${styles.divider} ${styles.dividerInPrimary}`} role="separator" aria-hidden="true" />
            ...
            <div className={styles.secondaryBlock}>
                ...
                <div className={styles.group}>
                    <span className={styles.iconBtnWrap} data-tooltip="Board System を開く">
                        <a
                            href={(process.env.NEXT_PUBLIC_BOARD_SYSTEM_URL || "https://wlboardsys.internal.wonder-link.com/boards").replace(/\/$/, "") + "/task"}
                            target="_blank"

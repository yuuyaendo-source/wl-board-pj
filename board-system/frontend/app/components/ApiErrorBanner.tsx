    ...
    <div className="mx-auto max-w-xl rounded-lg border border-amber-200 bg-amber-50 p-6 dark:border-amber-800 dark:bg-amber-950/30">
      ...
      {showApiUrlHint && (
        <div className="mb-4 text-sm text-amber-800 dark:text-amber-300">
          <p className="mb-1">本番では <code className="rounded bg-amber-100 px-1 dark:bg-amber-900/50">NEXT_PUBLIC_API_URL</code> を API の URL（例: http://wl-sticky-note.local/boards-api）に設定し、ビルドし直してください。</p>

...
_DESKTOP_APP_RELEASES_DIR = (
    Path(__file__).resolve().parent.parent / "desktop_app_releases"
)
...
async def lifespan(app: FastAPI):
    ...
    from app.services.llm_settings import (
        get_effective_llm_target_sync,
        get_resolved_ollama_sync,
    )
...
if _DESKTOP_APP_RELEASES_DIR.is_dir():
    app.mount(
        "/desktop-app",
        StaticFiles(directory=str(_DESKTOP_APP_RELEASES_DIR)),
        name="desktop_app_releases",
    )
